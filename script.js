/* elem.innerHTML is used to populate a div with HTML. Create a website with a div tag containing a random joke given an array of jokes. Use Math.random to fetch the joke from the array. Your website should show a random joke every time the website is reloaded */
let jokes_arr = [
...
let random_num = Math.floor(Math.random() * 125)
// console.log(random_num)
document.getElementById("text").innerHTML = jokes_arr[random_num]
